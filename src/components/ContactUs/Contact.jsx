  ...
  return (
    <div id="ContactUs">
       <Helmet>
        ...
        <meta name="description" content="you can make contact with us through this form for consultant " />
      ...
      <section className="contact section-bg">
        <div className="container">
          ...
          <div className="row">
            ...
            >
              <div className="info-box  mb-4">
              <a  href="mailto:blackbulltechnology@gmail.com"> <i class="fa-solid fa-envelope"></i></a>
                <h3>Email Us</h3>
